...
- [x] Refine the quotation header into a true centred-logo three-zone layout.
- [x] Soften and enlarge the continuous viewer with narrow grey gutters.
- [x] Lighten quotation typography and remove card-heavy document styling.
